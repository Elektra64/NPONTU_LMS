...
<body class="min-h-screen flex items-center justify-center p-4">
    ...
    <div
        ...
        <form class="p-6 space-y-6" method="POST" id="signUpForm">
            ...
            <div>
                <button type="submit"
                    class="submitSignupForm w-full py-3 px-4 bg-blue-900 hover:bg-secondary text-white font-medium rounded-lg transition duration-300 transform hover:scale-105">
                    Create Account
                </button>
            </div>

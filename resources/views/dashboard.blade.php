            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <h1 class="text-xl font-bold text-accent-dark">
                            <a class="cursor-pointer" href="{{ route('home') }}"> EduVerse</a>
                        </h1>
                    </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md">
                    <div class="flex items-center mb-4">
                        <svg class="w-8 h-8 text-primary mr-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                            ...
                            <path
                                d="M20 3H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2zM12 7v10M7 12h10">
                            </path>
                        </svg>
                    ...
                    <div id="courseGrid" class="grid md:grid-cols-2 gap-6 p-6">
                        @if ($courses->count())
                            ...
                            @foreach ($courses as $course)
                                <div
                                    class="course-card bg-white border rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-all duration-300">
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="flex justify-between items-center mb-3">
                                            <span
                                                class="{{ $course->setColor($course->categories[0]->category_name, 'badge') }} px-2 py-1 rounded-full text-xs">{{ $course->categories[0]->category_name }}</span>
                                            <span
                                        ...
                                        <div class="mt-4 flex justify-center">
                                            <button onclick="viewCourseDetails(this)"
                                                data-url="{{ route('course_details', $course->id) }}"
                                                class="text-blue-600 hover:text-blue-800 text-sm font-medium px-4 py-2 bg-blue-50 rounded-md">
                                                View Details
                                            </button>
                                        </div>
                                    </div>
                        ...
                        <div class="activity-item">
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-sm text-gray-500">"Advanced JavaScript Patterns" was published by
                                        Admin</p>
                        ...
                        <div class="activity-item">
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-sm text-gray-500">Sarah completed "HTML Basics" quiz with 92% score
                                    </p>

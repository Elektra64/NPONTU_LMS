    ...
    <header class="bg-gray-900 text-white py-8">
        <div class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
                    ...
                    <nav class="flex text-sm text-gray-300 mb-2" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-1 md:space-x-2">
                            <li class="inline-flex items-center">
                                <a href="#" class="inline-flex items-center hover:text-yellow-400">
                ...
                <div class="flex items-center space-x-4">
                    <button class="bg-yellow-500 hover:bg-yellow-600 text-black font-bold px-6 py-2 rounded-full transition duration-300 flex items-center">
                        <i class="fas fa-share-alt mr-2"></i> Share
                    </button>
                    <button class="bg-gray-700 hover:bg-gray-600 text-white font-bold px-6 py-2 rounded-full transition duration-300 flex items-center">
        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <button class="bg-yellow-500 hover:bg-yellow-600 text-black px-4 py-2 rounded-full text-sm font-bold flex items-center">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <div class="mb-4 border border-gray-200 rounded-lg overflow-hidden">
                        <div class="module-toggle bg-gray-100 p-3 flex justify-between items-center cursor-pointer hover:bg-gray-200 transition duration-200">
                            <div class="flex items-center">
                                <div class="w-8 h-8 bg-yellow-400 rounded-full flex items-center justify-center text-black font-bold mr-3">1</div>
                    ...
                    <div class="mb-4 border border-gray-200 rounded-lg overflow-hidden">
                        <div class="module-toggle bg-gray-100 p-3 flex justify-between items-center cursor-pointer hover:bg-gray-200 transition duration-200">
                            <div class="flex items-center">
                                <div class="w-8 h-8 bg-yellow-400 rounded-full flex items-center justify-center text-black font-bold mr-3">2</div>
                    ...
                    <div class="mb-4 border border-gray-200 rounded-lg overflow-hidden">
                        <div class="module-toggle bg-gray-100 p-3 flex justify-between items-center cursor-pointer hover:bg-gray-200 transition duration-200">
                            <div class="flex items-center">
                                <div class="w-8 h-8 bg-gray-300 rounded-full flex items-center justify-center text-black font-bold mr-3">3</div>
                    ...
                    <div class="border border-gray-200 rounded-lg overflow-hidden">
                        <div class="module-toggle bg-gray-100 p-3 flex justify-between items-center cursor-pointer hover:bg-gray-200 transition duration-200">
                            <div class="flex items-center">
                                <div class="w-8 h-8 bg-gray-300 rounded-full flex items-center justify-center text-black font-bold mr-3">4</div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden mb-8">
                ...
                <div class="p-6">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <button class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold px-4 py-2 rounded flex items-center">
                            <i class="fas fa-arrow-left mr-2"></i> Previous Lesson
                        </button>
                        <div class="text-sm text-gray-600">Lesson 3 of 4 in this module</div>
                        <button class="bg-yellow-500 hover:bg-yellow-600 text-black font-bold px-4 py-2 rounded flex items-center">
                    ...
                    <div class="prose max-w-none">
                        ...
                        <p class="mb-4">ECMAScript 2015 (ES6) introduced many new features that have become fundamental to modern JavaScript development. In this lesson, we'll cover the most important ones you should know.</p>
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    ...
                                    <div class="mt-1 text-sm text-blue-700">
                                        <p>While arrow functions are great for concise code, they can't be used as constructors and don't have their own arguments object.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
console.log("Doubled numbers: " + doubled);</code></pre>
                ...
                <div class="bg-gray-50 p-4 border-t border-gray-200 flex justify-between items-center">
                    <div class="flex items-center">
                        <input type="checkbox" id="complete-lesson" class="h-5 w-5 text-yellow-500 rounded border-gray-300 focus:ring-yellow-500">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-6">
                    <div class="mb-6">
                        <textarea class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-400 focus:border-yellow-400" rows="3" placeholder="Have a question or comment about this lesson?"></textarea>
                        ...
                        <div class="flex space-x-4">
                            ...
                            <div class="flex-1">
                                <div class="bg-gray-50 p-4 rounded-lg">
                                    ...
                                    <p class="text-gray-700 mb-2">Can someone explain why arrow functions don't have their own 'this' context? I'm still a bit confused about when to use them vs regular functions.</p>
                                    <div class="flex space-x-4 text-sm text-gray-500">
                                        <button class="hover:text-yellow-500"><i class="fas fa-thumbs-up mr-1"></i> Like (5)</button>
                                        <button class="hover:text-yellow-500"><i class="fas fa-reply mr-1"></i> Reply</button>
                                    </div>
                                </div>
                                
                                <!-- Reply -->
                                <div class="flex space-x-4 mt-4 ml-10">
                                    <img src="https://randomuser.me/api/portraits/women/45.jpg" alt="User" class="w-8 h-8 rounded-full">
                                    <div class="flex-1">
                                        <div class="bg-gray-100 p-3 rounded-lg">
                                            ...
                                            <p class="text-gray-700 text-sm mb-1">Great question! Arrow functions inherit 'this' from their surrounding (lexical) context. This makes them ideal for callbacks where you want to preserve the 'this' from the outer scope. Regular functions have their own 'this', which is useful when you need dynamic context (like in methods).</p>
                                            <div class="flex space-x-3 text-xs text-gray-500">
                                                <button class="hover:text-yellow-500"><i class="fas fa-thumbs-up mr-1"></i> Like (8)</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="flex space-x-4">
                            ...
                            <div class="flex-1">
                                <div class="bg-gray-50 p-4 rounded-lg">
                                    ...
                                    <p class="text-gray-700 mb-2">The template literals example was really helpful! I didn't realize you could do multi-line strings so easily without concatenation.</p>
                                    <div class="flex space-x-4 text-sm text-gray-500">
                                        <button class="hover:text-yellow-500"><i class="fas fa-thumbs-up mr-1"></i> Like (3)</button>
                                        <button class="hover:text-yellow-500"><i class="fas fa-reply mr-1"></i> Reply</button>
                                    </div>
                                </div>
                            </div>

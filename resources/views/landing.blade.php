...
<body class="bg-gray-900 text-white font-sans">
    ...
    <nav class="bg-gray-900/90 backdrop-blur-md text-white p-4 flex justify-between items-center sticky top-0 z-50 shadow-lg border-b border-gray-800">
        ...
        <div class="flex items-center space-x-4">
            ...
            <a href="{{ route('register') }}" class="bg-yellow-500 hover:bg-yellow-600 text-black font-bold px-6 py-2 rounded-full transition duration-300 transform hover:scale-105">
        ...
        <div class="container mx-auto px-4 py-32 relative z-10">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-6">
                    <a href="{{ route('register') }}" class="bg-yellow-500 hover:bg-yellow-600 text-black font-bold px-8 py-4 rounded-full transition duration-300 transform hover:scale-105 flex items-center justify-center cta-pulse">
                        <i class="fas fa-rocket mr-2"></i> Start Learning Free
                    </a>
                    <a href="{{ route('register') }}" class="bg-transparent hover:bg-white/10 text-white font-bold px-8 py-4 rounded-full border-2 border-yellow-400 transition duration-300 transform hover:scale-105 flex items-center justify-center">

    ...
    <nav class="bg-gray-900 text-white p-4 flex justify-between items-center sticky top-0 z-50 shadow-lg">
        <div class="flex items-center space-x-8">
            ...
            <div class="hidden md:flex space-x-6">
                <a href="#"
                    class="text-yellow-400 hover:text-yellow-300 transition duration-300 flex items-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#"
                                class="text-gray-400 hover:text-yellow-400 transition duration-300">Terms</a></li>
                        <li><a href="#"
                                class="text-gray-400 hover:text-yellow-400 transition duration-300">Privacy</a></li>
                    </ul>
                </div>
                <div>
                    ...
                    <p class="text-gray-400"><i class="fas fa-map-marker-alt mr-2"></i> 123 Education St, Learning
                        City</p>
                </div>
            </div>

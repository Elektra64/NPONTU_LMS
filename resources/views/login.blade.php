...
<body class="min-h-screen flex items-center justify-center p-4">
    ...
    <div class="fixed top-0 left-0 w-full h-full overflow-hidden z-0 pointer-events-none">
        <div class="absolute top-1/4 left-1/5 w-16 h-16 rounded-full bg-primary/10 animate-float" style="animation-delay: 0s;"></div>
        <div class="absolute top-1/3 right-1/4 w-24 h-24 rounded-full bg-secondary/10 animate-float" style="animation-delay: 2s;"></div>
        <div class="absolute bottom-1/4 left-1/3 w-20 h-20 rounded-full bg-accent-light/10 animate-float" style="animation-delay: 4s;"></div>
    </div>
    ...
    <div class="form-container relative z-10 w-full max-w-md rounded-2xl overflow-hidden border border-gray-200/50">
        ...
        <div class="bg-gradient-to-r from-primary to-secondary p-8 text-center">
            ...
            <p class="text-accent-light/90">🌟 EduVerse: Where Knowledge Meets You! Sign in and unlock limitless learning opportunities.</p>
        </div>
        ...
        <form class="p-8 space-y-6" method="POST" action="{{ route('login.post') }}">
            ...
            <div class="grid grid-cols-2 gap-4">
                <a href="#" class="flex items-center justify-center space-x-2 p-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition">

...
const closeModuleButton = document.getElementById("closeModuleModal");
...
addModuleButton.addEventListener("click", () => openAddModuleModal());
closeModalBtn.addEventListener("click", closeModal);
cancelCourseBtn.addEventListener("click", closeModal);
closeModuleButton.addEventListener("click", closeAddModuleModal);
